...
- # Vulnerabilità dei frame:
	- è il tempo in cui un frame viaggia dal trasmettitore al ricevitore e durante il quale può collidere con un altro frame e eventualmente venir sopraffatto 
	- Esistono metodi per diminuire questa finestra che sono implementati da vari protocolli di comunicazione.
